...
export const COUNTRIES: Country[] = [
    // --- EUROPE ---
    { name: 'Albania', code: 'AL', population: 2.8, region: 'Europe' },
    { name: 'Austria', code: 'AT', population: 9.0, region: 'Europe' },
    { name: 'Belgium', code: 'BE', population: 11.6, region: 'Europe' },
    { name: 'Bosnia and Herzegovina', code: 'BA', population: 3.2, region: 'Europe' },
    ...
    { name: 'North Macedonia', code: 'MK', population: 2.1, region: 'Europe' },
    ...
    { name: 'Serbia', code: 'RS', population: 6.7, region: 'Europe' },
    ...
    { name: 'Syria', code: 'SY', population: 22.1, region: 'MENA' },
